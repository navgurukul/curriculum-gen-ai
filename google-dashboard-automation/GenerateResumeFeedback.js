/**
 * Generates resume feedback for each row in the active spreadsheet.
 */
...
/**
 * Extracts text from a PDF file using its file ID.
 * @param {string} fileId - The ID of the PDF file.
 * @returns {string|null} - The extracted text or null if an error occurred.
 */
...
/**
 * Generates feedback for the given resume text and role.
 * @param {string} text - The resume text.
 * @param {string} role - The role for which the feedback is generated.
 * @returns {string} - The generated feedback.
 */
function generateFeedback(text, role) {
    var apiKey = process.env.API_KEY; // Replace with your actual API key
    var url = process.env.API_SECRET + apiKey;
...
/**
 * Formats the generated feedback content.
 * @param {string} content - The generated feedback content.
 * @returns {string} - The formatted feedback content.
 */
...
/**
 * Sends an email with the generated feedback.
 * @param {string} email - The recipient's email address.
 * @param {string} feedback - The generated feedback.
 * @param {string} role - The role for which the feedback is generated.
 */
